...
// TODO: still need to figure out, how to get the real serverUrl
function actionPublish (req, res, note) {
  res.redirect("https://LiaScript.github.io/course/?http://localhost:3000/" + config.serverURL + 's/' + (note.alias || note.shortid) + '/download')
}
