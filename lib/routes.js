...
// get new note  for gitlab content
appRouter.get('/new/gitlab/:gitlabid(*)', response.newGitLabNote)
// post new note for gitlab content
appRouter.post('/new/gitlab/:gitlabid(*)', markdownParser, response.newGitLabNote)
// get publish note
